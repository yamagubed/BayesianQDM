...
Suppose that random variables of the number of response observed in treatment group for PoC study is denoted by $y_t$ where we assume $y_t \sim Bin(n_t,\pi_t)$.
Assume that a hypothetical posterior distribution for the response rate of control group is $\pi_c \sim Beta(\alpha_t + z, \beta_t + n_t - z)$, where $z$ controls the variance of control group response rate.
